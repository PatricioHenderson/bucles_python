...
def ej3():
    ...
    for i in range(len(numeros)):
        ...
        print("El resultado de sumar " ,numero , "+", numero_2 , "es ", suma)
       
        #print("El resultado de la suma ", i + 1 , "es {}" .format(suma))
    ...
    for i in numeros:
        ...
        print("El resultado de la suma número ", x , "es {} " .format(suma))
...
def ej6():
    ...
    inicio = int(input('Ingrese el primer número de la secuencia\n'))
    fin = int(input("Ingresar el segundo número de la secuencia \n"))
    ...
    print("Números negativos = ", cantidad_numero_negativos,
    "numeros positivos = " , cantidad_numeros_positivos )
